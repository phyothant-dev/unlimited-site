...
export default function ProjectDetail({ project, onVote, onClose }) {
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          exit={{ opacity: 0, y: 20 }}
          style={{ background: '#fff', borderRadius: 16, width: '100%', maxWidth: 560, alignSelf: 'flex-start', margin: '40px 0', border: '1px solid #eee' }}
